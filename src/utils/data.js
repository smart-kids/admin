...
`;
        ...
        const FRAGMENT_CLASSES_DATA = `fragment ClassesData on school { classes { id name feeAmount grade students { id, names, gender, registration, parent { id, name, phone }, parent2 { id, name }, route { id, name }, feeStatus { balance, balanceFormated }, balanceBroughtForward } teacher { id, name } } }`;
