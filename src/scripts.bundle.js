...
let KTAppOptions = window.KTAppOptions
let Chart = window.Chart
let browserSupportsBoxModel = window.browserSupportsBoxModel
let Cookies = window.Cookies
let DOMPurify = window.DOMPurify
let moment = window.moment
let PerfectScrollbar = window.PerfectScrollbar
...
let KTUtilElementDataStore = window.KTUtilElementDataStore
let KTUtilElementDataStoreID = window.KTUtilElementDataStoreID
let KTUtilDelegatedEventHandlers = window.KTUtilDelegatedEventHandlers;
...
var KTPortlet = function (elementId, options) {
     ...
     */
    the.remove = function () {
        return Plugin.remove(window.html);
    };
...
window.KTQuickSearch = KTQuickSearch
