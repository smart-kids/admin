...
class List extends Component {
    ...
    componentDidMount() {
        this.unsubscribe = Data.budgets.subscribe(this.handleDataUpdate);
    }
    ...
    handleDataUpdate = (data) => {
        this.setState({ data: data.budgets || [] });
    };
            ...
            <div className="kt-portlet kt-portlet--mobile">
                <div className="kt-portlet__head kt-portlet__head--lg">
                    <div className="kt-portlet__head-label">
                        ...
                        <h3 className="kt-portlet__head-title">Manage Budgets</h3>
                    </div>
                            ...
                            <tbody>
                                {data.map(item => (
                                    <tr key={item.id}>
                                        ...
                                        <td>{item.startDate ? new Date(parseInt(item.startDate)).toLocaleDateString() : '-'}</td>
                                        <td>{item.endDate ? new Date(parseInt(item.endDate)).toLocaleDateString() : '-'}</td>
