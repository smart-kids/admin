...
class Edit extends Component {
    ...
    handleSubmit = async (e) => {
        ...
        try {
            ...
            if(window.toastr) window.toastr.success("Budget updated successfully!");
            this.props.close();
        } catch (error) {
            console.error(error);
            if(window.toastr) window.toastr.error("Failed to update Budget.");
        } finally {
