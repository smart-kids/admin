    ...
    handleSubmit = async (e) => {
        ...
        try {
            ...
            await Data.expenses.update({
                ...
                description,
                receiptImage: receiptImageUrl || this.props.data.receiptImage,
                school
            });
            if(window.toastr) window.toastr.success("Expense updated successfully!");
            this.props.close();
        } catch (error) {
            console.error(error);
            if(window.toastr) window.toastr.error("Failed to update Expense.");
        } finally {
                    ...
                    <form onSubmit={this.handleSubmit}>
                        ...
                        <div className="form-group row">
                            ...
                            <div className="col-9">
                                ...
                                {this.props.data.receiptImage && <a href={this.props.data.receiptImage} target="_blank" rel="noopener noreferrer">View Current Receipt</a>}
                            </div>
                        </div>
                        <div className="form-group row">
